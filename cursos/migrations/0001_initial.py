# Generated by Django 4.0.6 on 2024-04-21 13:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linguagens', models.ManyToManyField(to='cursos.linguagem_programacao', verbose_name='Linguagens de Programação')),
            ],
        ),
        migrations.CreateModel(
            name='Docente',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100, verbose_name='Nome')),
                ('disciplina', models.ManyToManyField(to='cursos.disciplina', verbose_name='Disciplina/s')),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
            fields=[
                ...
                ('disciplinas', models.ManyToManyField(related_name='cursos', to='cursos.disciplina', verbose_name='Disciplinas')),
            ],
        ),
    ]
